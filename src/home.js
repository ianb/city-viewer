  ...
  return <Page title={`About ${city.title}`} back="#/city">
    <div class="flex flex-col items-center justify-center h-full">
      ...
      <TextBox class="w-1/2">
        ...
        <p class="my-3">This is just the beginning of what's possible, think of it as source material for a world you can interact with. I hope it lets you see the potential!</p>
      </TextBox>
    </div>
  </Page>;
};
